...
import java.awt.image.BufferedImage;  
  /*
<applet code="mini_project_3" width=500 height=500>
</applet>
*/
  
public class mini_project_3 extends Applet {  
  
  Image picture;  
  
  public void init() {  
    picture = getImage(getDocumentBase(),"PicsArt_03-22-08.04.20.jpg");
...
*/
showStatus("No parking space available .");
  }  
