...
import java.awt.image.BufferedImage;  
  /*
<applet code="mini_project_2" width=500 height=500>
</applet>
*/
  
public class mini_project_2 extends Applet {  
  
  Image picture;  
  
  public void init() {  
    picture = getImage(getDocumentBase(),"preview.jpg");
  ...
  public void paint(Graphics g) {  
	...
	height=bi.getHeight();
	int t=370;
	//g.drawString("height : "+height+ "width : "+width,350,400);
...
//g2d.draw(new Line2D.Float(130.50f,270.50f,130.0f,350.0f));    //parking space 11  already filled
...
//g2d.draw(new Line2D.Float(155.50f,270.50f,155.0f,350.0f));    //parking space 12  already filled
//g2d.draw(new Line2D.Float(50.50f, 270.50f, 170.50f, 270.50f));
//g2d.draw(new Line2D.Float(170.50f,270.50f,170.0f,200.0f));    //parking space 3 already filled
...
//g2d.draw(new Line2D.Float(290.50f,270.50f,290.0f,350.0f));    //parking space 15 already filled
//g2d.draw(new Line2D.Float(50.50f, 270.50f, 315.50f, 270.50f));
//g2d.draw(new Line2D.Float(315.50f,270.50f,315.0f,200.0f));    //parking space 6 already filled
//g2d.draw(new Line2D.Float(50.50f, 270.50f, 340.50f, 270.50f));
//g2d.draw(new Line2D.Float(340.50f,270.50f,340.0f,200.0f));    //parking space 7 already filled
...
//g2d.draw(new Line2D.Float(350.50f,270.50f,350.0f,350.0f));    //parking space 17 already filled
...
//g2d.draw(new Line2D.Float(400.50f,270.50f,400.0f,200.0f));    //parking space 9  already filled
