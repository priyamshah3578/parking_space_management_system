...
import java.awt.image.BufferedImage;  
  /*
<applet code="mini_project_1" width=500 height=500>
</applet>
*/
  
public class mini_project_1 extends Applet {  
  
  Image picture;  
  
  public void init() {  
    picture = getImage(getDocumentBase(),"PicsArt_03-22-07.49.43.jpg");
...
//	g.fillRect(168,195,3,3); //parking space 3          //Herin : You need  to do this part
